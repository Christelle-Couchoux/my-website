...
<head>
    ...
    <title>Home - Christelle Couchoux</title>
    <meta name="title" content="Christelle Couchoux">
    <meta name="description" content="Christelle Couchoux, Full Stack Web Developer. 
    On my site you can learn about my skills and experience, download my resume, 
    discover the different projects I've worked on, and contact me.">
    <link rel=”canonical” href="https://www.christelle-couchoux.com"/>
            ...
            <div class="fixed-header>">
                <header class="page-header">
                    ...
                    <div class="language">
                        ...
                        <div class="language__choice">
                            <p class="language__active language__active--main" title="English">
                                EN
                            </p>
                        </div>
                    </div>
            ...
            <main>
                ...
                <section id="home">
                    ...
                    <div class="home-txt">
                        ...
                        <h1>
                            I'm <span class="highlights">Christelle Couchoux</span>,<br>
                ...
                <section id="about" class="hidden-section">
                    ...
                    <div class="about-txt">
                        <p>
                            Hi ! My name is <span class="highlights">Christelle</span> and I’m French. After 10+ years doing 
                            scientific research, I retrained and became a <span class="highlights">full stack web developer</span>.
                        </p>
                        <p>
                            I’m <span class="highlights">curious</span> and love discovering new things. My capacity to adapt and 
                            understand makes me a <span class="highlights">fast learner.</span> And, because of my logic, rigor 
                            and career as a researcher, I have great <span class="highlights">problem solving</span> skills.
                        </p>
                        <p>
                            After completing a 6-month training program, I obtained a 
                            <span class="highlights">‘Web Developer’ diploma</span> (Associate’s level).
                        </p>
                        <p class="looking-for-job">
                            I'm currently free and looking for a junior web developer position.
                        </p>
                        <p>
                            Here are some of the <span class="highlights">technologies</span> I'm working with:
                        </p>
                ...
                <section id="projects" class="hidden-title">
                    ...
                    <div class="all-projects">
                        ...
                        <div class="one-project enter-right hidden-project">
                            <h3>Full stack development of a corporate social network</h3>
                            ...
                            <div class="one-project__title-links">
                                ...
                                <div>
                                    ...
                                    <a href="https://youtu.be/lA9LT5DqRiM" target="_blank" title="Demo">
                                        <i class="fas fa-video" aria-label="Demo" role="img"></i>
                                    </a>
                                </div>
                            </div>
                            
                            <div class="one-project__image">
                                <a href="https://github.com/Christelle-Couchoux/Groupomania" target="_blank" title="Go to Groupomania project's code">
                            ...
                            <p class="one-project__more-info" id="more-info-groupomania">More info</p>

                            <div class="modal modal-content" id="modal-content-groupomania" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">Groupomania - Corporate social network</p>
                                    <p class="one-project__content__txt">
                                        After registering/logging in, users can view all the messages, 
                                        share a message (an image, a short text, or both), 
                                        add a comment to a message, like a message, 
                                        personnalize their profile with an avatar and a bio, 
                                        find a user by name, 
                                        view all the messages, comments and likes of any user, 
                                        and delete their own messages, comments and likes, or even account.
                                    </p>
                        ...
                        <div class="one-project enter-left hidden-project">
                            <h3>Back end development of a secure API</h3>
                            ...
                            <div class="one-project__title-links">
                                ...
                                <div>
                                    ...
                                    <a href="https://youtu.be/lIGCWH2boQ4" target="_blank" title="Demo">
                                        <i class="fas fa-video" aria-label="Demo" role="img"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="one-project__image">
                                <a href="https://github.com/Christelle-Couchoux/Piquante" target="_blank" title="Go to Piquante project's code">
                                    <div class="one-project__image__photo">
                            ...
                            <p class="one-project__more-info" id="more-info-piquante">More info</p>

                            <div class="modal modal-content" id="modal-content-piquante" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">Piquante - Secure API</p>
                                    <p class="one-project__content__txt">
                                        After registering/logging into the hot sauce rating app, 
                                        users can view all the sauces, 
                                        add a new sauce (with photo, description, rating, etc.), 
                                        like or dislike a sauce, 
                                        and modify or delete a sauce they've added. 
                                        The API is secure and respect the GDPR and OWASP standards.
                                    </p>
                                    <ul class="one-project__content__technologies">
                                        <li title="Node.js" class="node" aria-label="Node.js">
                                            <svg class="tech-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 442.37 270.929">
                        ...
                        <!-- Oricamera -->
                        <div class="one-project enter-right hidden-project">
                            <h3>Front end development of an e-commerce website</h3>
                            ...
                            <div class="one-project__title-links">
                                ...
                                <div>
                                    ...
                                    <a href="http://oricamera.christelle-couchoux.com/html/index.html" target="_blank" title="Website">
                            ...
                            <div class="one-project__image">
                                <a href="http://oricamera.christelle-couchoux.com/html/index.html" target="_blank" title="Go to Oricamera project's website">
                                    <div class="one-project__image__photo">
                            ...
                            <p class="one-project__more-info" id="more-info-oricamera">More info</p>

                            <div class="modal modal-content" id="modal-content-oricamera" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">Oricamera - E-commerce website</p>
                                    <p class="one-project__content__txt">
                                        On this website selling vintage cameras, 
                                        users can view a list of all the products available, 
                                        view a specific product (with its description, price, options, etc.), 
                                        add a product to the cart, change the quantity of a product in the cart, 
                                        remove a product from the cart, empty the cart, 
                                        send the order, and receive a order confirmation.
                                    </p>
                                    <ul class="one-project__content__technologies">
                                        <li title="HTML5" class="html5" aria-label="HTML5">
                                            <svg class="tech-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        <!-- La Chouette Agence -->
                        <div class="one-project enter-left hidden-project">
                            <h3>SEO optimisation of a website</h3>
                            ...
                            <div class="one-project__title-links">
                                ...
                                <div>
                                    ...
                                    <a href="https://christelle-couchoux.github.io/La-Chouette-Agence/" target="_blank" title="Website">
                                        <i class="fas fa-external-link-alt" aria-label="Link" role="img"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="one-project__image">
                                <a href="https://christelle-couchoux.github.io/La-Chouette-Agence/" target="_blank" title="Go to La Chouette Agence project's website">
                                    <div class="one-project__image__photo">
                            ...
                            <p class="one-project__more-info" id="more-info-chouette">More info</p>

                            <div class="modal modal-content" id="modal-content-chouette" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">La Chouette Agence - SEO optimisation</p>
                                    <p class="one-project__content__txt">
                                        Improvment of the website of a web design agency to optimize 
                                        the load time, the responsive design, the site structure, 
                                        the accessibility, the content and keywords, 
                                        and the external links.<br>
                                        (The website before optimisation is available <a href="https://christelle-couchoux.github.io/La-Chouette-Agence-before/" target="_blank"><span class="txt-link-project">here</span></a>)
                                    </p>
                                    <ul class="one-project__content__technologies">
                                        <li title="HTML5" class="html5" aria-label="HTML5">
                                            <svg class="tech-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        <!-- Oh My Food! -->
                        <div class="one-project enter-right hidden-project">
                            <h3>Implementation of a website with animations</h3>
                            ...
                            <div class="one-project__title-links">
                                ...
                                <div>
                                    ...
                                    <a href="https://christelle-couchoux.github.io/ChristelleCouchoux_3_08042021/html/index.html" target="_blank" title="Website">
                                        <i class="fas fa-external-link-alt" aria-label="Link" role="img"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="one-project__image">
                                <a href="https://christelle-couchoux.github.io/ChristelleCouchoux_3_08042021/html/index.html" target="_blank" title="Go to Oh My Food ! project's website">
                                    <div class="one-project__image__photo">
                            ...
                            <p class="one-project__more-info" id="more-info-ohmyfood">More info</p>

                            <div class="modal modal-content" id="modal-content-ohmyfood" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">Oh My Food ! - Implementation with animations</p>
                                    <p class="one-project__content__txt">
                                        The app lists restaurants and 
                                        allows users to order food in advance. 
                                        There are animations while the main page is loading, 
                                        when a user likes a restaurant, when the different dishes appear, 
                                        and when a dish is selected.
                                    </p>
                                    <ul class="one-project__content__technologies">
                                        <li title="HTML5" class="html5" aria-label="HTML5">
                                            <svg class="tech-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        ...
                        <!-- Portfolio -->
                        <div class="one-project enter-left hidden-project">
                            <h3>Development of a portfolio website</h3>
                            ...
                            <p class="one-project__more-info" id="more-info-portfolio">More info</p>

                            <div class="modal modal-content" id="modal-content-portfolio" title="Click to close">
                                <div class="one-project__content">
                                    <p class="one-project__content__description">My portfolio website</p>
                                    <p class="one-project__content__txt">
                                        This very site. Here you can learn about my skills and experience, 
                                        discover the different projects I have worked on, and contact me.
                                    </p>
                                    <ul class="one-project__content__technologies">
                                        <li title="HTML5" class="html5" aria-label="HTML5">
                                            <svg class="tech-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
