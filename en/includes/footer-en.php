<footer>
    <nav id="footer-links">
        <ul>
            <li>
                <a href="./home.php#contact" title="Contact Me">
            ...
            <li>
                <a href="./resume.php" title="Go to my resume">
                    <span class="cv-icon">
                        CV
                    </span>
                </a>
    ...
    <p id="legal">
        ...
        <a href="../mentions-legales.php"><span class="legal-link">Legal notice</span></a>
        <a href="../cgu.php"><span class="legal-link">T&C</span></a>
    </p>
</footer>